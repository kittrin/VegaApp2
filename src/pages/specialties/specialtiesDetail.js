    ...
    return (
        ...
        >
            ...
            <View style={styles.title_main}>
                <Pressable style={styles.btn_block} onPress={() => navigation.navigate('specialties')}>
        ...
        isLoading ? <Loader/>
            ...
            <View style={styles.page}>
                ...
                <Text style={styles.block}>Количество бюджетных
                    мест: <Text style={styles.txtNumber}>{data.budgetPlaces ? data.budgetPlaces : "Неизвестно"}</Text></Text>
                <Text style={styles.block}>Проходной балл на бюджетную
                    основу: <Text style={styles.txtNumber}>{data.budgetPassingScore ? data.budgetPassingScore : "Неизвестно"}</Text></Text>
                <Text style={styles.block}>Количество мест по
                    договору: <Text style={styles.txtNumber}>{data.contractPlaces ? data.contractPlaces : "Неизвестно"}</Text></Text>
                <Text style={styles.block}>Проходной балл на
                    договор: <Text style={styles.txtNumber}>{data.contractPassingScore ? data.contractPassingScore : "Неизвестно"}</Text></Text>
                <Text style={styles.block}>Цена договора (очно,
                    руб): <Text style={styles.txtNumber}>{data.intramuralPrice ? data.intramuralPrice : "Неизвестно"}</Text></Text>
                <Text style={styles.block}>Цена договора (заочно,
                    руб): <Text style={styles.txtNumber}>{data.absentiaPrice ? data.absentiaPrice : "Неизвестно"}</Text></Text>
                <Text style={styles.block}>Цена договора (очно-заочно,
                    руб): <Text style={styles.txtNumber}>{data.partTimePrice ? data.partTimePrice : "Неизвестно"}</Text></Text>
            </View>
    }
        </ScrollView>
    )
