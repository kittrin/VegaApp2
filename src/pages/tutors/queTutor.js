...
export const QueTutor = ({navigation}) => {
      ...
      >
          ...
          <View style={styles.main}>
              <Text style={styles.question}>
                  Ты хотел бы заниматься в учебном центре или с частным репетитором?
              </Text>
              <Pressable
                  style={({pressed}) => [
                      {
                  ...
                  onPress={() => navigation.navigate('que-tutor-2')}
              >
                  <Text style={styles.answerText}>Репетитор</Text>
              </Pressable>
              <Pressable
                  style={({pressed}) => [
                      {
                ...
                onPress={()=>navigation.navigate('list-online-school')}
              >
                  <Text style={styles.answerText}>Учебный центр</Text>
              </Pressable>
          </View>
      </ScrollView>
  )
